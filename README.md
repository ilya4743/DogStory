...
DogStory — многопользовательская игра для ПК, доступная прямо в браузере. Управляйте собакой, собирайте предметы и соревнуйтесь с друзьями!<br><br>
Цель игры собирать предметы по карте и относить их на базу.<br><br>
На выбор доступно 3 карты.<br>
![Выбор карты](pictures/choose%20map.png)<br>
Предметы нужно относить к зелёному дому с рожком наверху.<br><br>
Управление осуществляется на стрелочки, на клавиатуре.<br><br>
![Игра](pictures/game.png)<br>
Игра автоматически завершится при бездействии игрока несколько секунд.<br>
Рекорд игрока зарегистрируется в базе данных и выведется таблица рекордов.<br>
![Таблица рекордов](pictures/records.png)<br>
